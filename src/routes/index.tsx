    ...
    <div className="studio-shell">
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1560px] flex-col">
        <header className="flex min-h-24 items-center justify-between gap-4 border-b border-hairline/70 py-5 sm:min-h-28 sm:py-6">
          <a href="/" aria-label="Onyx.Core home" className="flex min-w-0 items-center gap-3 rounded-xl sm:gap-4">
            <span className="studio-mark" aria-hidden="true">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M12 2.5 21 7.75v8.5L12 21.5 3 16.25v-8.5L12 2.5Z" stroke="currentColor" strokeWidth="1.2" />
            ...
            <span className="flex min-w-0 flex-col">
              ...
              <span className="text-xs text-muted-foreground">A personal screening room</span>
            </span>
          </a>
          ...
          <div className="flex shrink-0 items-center gap-2 rounded-full border border-hairline bg-panel/60 px-3 py-2 text-xs text-muted-foreground sm:px-4">
            ...
            <span>Local-first<span className="hidden sm:inline"> by design</span></span>
          </div>
        </header>
        ...
        <footer className="flex flex-col gap-3 border-t border-hairline/70 py-5 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:py-6">
          ...
          <p className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <span><kbd className="rounded border border-hairline bg-panel px-1.5 py-0.5 font-mono text-[11px]">Space</kbd> to pause</span>
            <span><kbd className="rounded border border-hairline bg-panel px-1.5 py-0.5 font-mono text-[11px]">?</kbd> for shortcuts</span>
          </p>
        </footer>
      </div>
    </div>
...
function PlayerSkeleton() {
  return (
    <div role="status" aria-label="Loading your player" className="flex flex-col gap-6">
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_340px] xl:grid-cols-[minmax(0,1fr)_360px]" aria-hidden="true">
        <div className="aspect-video min-h-[280px] rounded-2xl border border-hairline bg-panel" />
